...
VALUES
    ('Tonis Courtyard Cafe', '516 W 18th St, Merced, CA', 2, 
     ...
     1, 'http://www.toniscourtyardcafe.com/', '209-384-2580', 'contact@example.com'),
    ...
    ('Joystiq', '325 W Main St, Merced, CA', 3, 
     ...
     1, 'http://www.joystiqmerced.com/', '209-455-3300', 'joystiqmerced@gmail.com'),
    ...
    ('Kind Neighbor', '1635 M St, Merced, CA', 2, 
     ...
     1, 'http://www.kindneighborjuicebar.com/', '209-617-6538', 'kindneighborinfo@gmail.com'),
    ...
    ('Oishi Teri Sushi Bar', '235 W Main St, Merced, CA', 4, 
     ...
     17, 'http://www.oishisushibar.com', '209-653-5859', 'contact@example.com'),

    ('El Palmar Taqueria', '1127 Martin Luther King Jr Way, Merced, CA', 1, 
     ...
     21, 'http://www.elpalmartaqueria.com/', '209-726-8855', 'contact@example.com');
